...
////////////////////////////////////////////
 ...
 class linkedList{
        ...
        public void display(){
            Node here = head.next;   
            while (here != null) {
                    System.out.println("Key = " + here.key + " Data = " + here.data);
                    here = here.next; }
 ...
 public class tryList {
        public int n = 2;
            ...
            String theFileName = args[0];
                        if (args.length == 1) {
                                try {
                                    FileInputStream inFileName = new FileInputStream (theFileName);
                                    DataInputStream inFile = new DataInputStream (inFileName);
                                    System.out.println("File: " + theFileName + " successfully opened");
                                ...
                                // Key = 2410832 Data = Van Zitters, ST
                                    int spacePos = inString.substring(10, commaPos).indexOf(" ") + 10;
                                    int minusPos = inString.substring(10, commaPos).indexOf("-") + 10; }



                    if (spacePos > 10){
                        int outString = inString.substring(0, 10)+ inString.substring(10, spacePos).toLowerCase()
   ...
   System.err.println("File: "+ theFileName + " error occurred"); } }
 else {
  System.err.println("There are " + args.length + "parameters, there should be 1"); } }
